//Generic code using class with OOP by removing functions out of class with dyanmic objects
...
int main()
{
    ...
    Arithematic<double> *dobj = new Arithematic<double>(11.5289,10.2654);
