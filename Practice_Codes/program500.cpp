...
///////////////////////////////////////////////////////////
//       singlyLL using generic approach
///////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////
//         DoublyLL using generic approach
///////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   Stack<char> *sobj = new Stack<char>();
    ...
    sobj->push('d');
    sobj->Display();
    cout<<"Number of Elements is Stack are :"<<sobj->Count()<<"\n";
...
Queue<double> *qobj = new Queue<double>();
    ...
    qobj->enqueue(11.5689);
    qobj->enqueue(21.56789);
    qobj->enqueue(51.5689);
    qobj->enqueue(101.56789);
    qobj->Display();
    cout<<"Number of Elements is Queue are :"<<qobj->Count()<<"\n";
